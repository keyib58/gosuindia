...
export default async function Home({ params }: { params: { slug?: string } }) {
  ...
  // Define meta information based on URLs
  const metaInfo: { [key: string]: { title: string; description: string } } = {
    "/": {
    ...
    "/entertainment": {
      title:
        "Latest Esports News, Gaming News and Anime Updates | GosuGamers",
      description:
  ...
  const { title, description } = metaInfo[currentPath] || metaInfo["/"];
